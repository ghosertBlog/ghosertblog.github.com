...
```
此时本地 127.0.0.1:7070 这个地址端口已经成为类似代理服务器 C 的机器，你只需要在任意 GUI 程序的代理服务器选项或者上述 /etc/proxychains.conf 文件中最后追加一行 socket5 127.0.0.1 7070 即可。
